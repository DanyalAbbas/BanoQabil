...
def start_menu(root):
    ...
    while True:
        ...
        root.blit(text_render("Assets/broking.ttf", 15, "DESCRIPTION:  This program translates sign language into english language", (255, 255, 255)), (10, 5))
